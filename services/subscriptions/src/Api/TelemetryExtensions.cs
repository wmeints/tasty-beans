    ...
    public static void AddTelemetry(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddOpenTelemetryMetrics(options =>
        {
            options
                ...
                .AddHttpClientInstrumentation()
                .AddAspNetCoreInstrumentation()
                .AddMeter("RecommendCoffee.Subscriptions.Api")
                .AddMeter("RecommendCoffee.Subscriptions.Application")
                .AddMeter("RecommendCoffee.Subscriptions.Domain")
                .AddMeter("RecommendCoffee.Subscriptions.Infrastructure")
                .AddOtlpExporter(exporterOptions =>
                {
                    exporterOptions.Endpoint = new Uri(builder.Configuration["Otlp:Endpoint"]);
                });
